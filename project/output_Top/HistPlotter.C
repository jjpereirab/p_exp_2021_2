...
void HistPlotter(){
  ...
  h_err->Draw("e2same");
  h_data->Draw("epsame");
   // h_signal->Draw("histsame");  //  alert!!!  alert!!!  alert!!!  alert!!!  alert!!!  alert!!!  alert!!!  alert!!!  alert!!!  alert!!!  alert!!!
  ...
  // leg->AddEntry(h_signal,("Z'(" + signalmass + " GeV)#rightarrow t#bar{t} x 10^{4}").c_str(),"l");  // alert!!!  alert!!!  alert!!!  alert!!!  alert!!!  alert!!!  alert!!!
  leg->Draw();
  ...
  float datasig = h_data->Integral();
  float s = h_zjets->Integral();
  float b = h_db->Integral() + h_drellyan->Integral() + h_wjets->Integral() + h_singletop->Integral() + h_ttbar->Integral();

  std::cout<< "S " << s << std::endl;
  std::cout<< "B " << b << std::endl;
  std::cout<< "Data " << datasig << std::endl;
  std::cout<< "Data/MC " << datasig/(s+b) << std::endl;
  std::cout<< "purity " << s/(s+b) << std::endl;
  std::cout<< "significance " << s/TMath::Sqrt(s+b) << std::endl;
  std::cout<< "efficiency " << s/b << std::endl;
